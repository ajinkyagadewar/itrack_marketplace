...
//////////////////////////payumoney setting//////////////////////////
	...
	//new payumoney currency code is added by prashant 
	$paypalcurrencies = local_buykart_get_currencies();
	$settings->add(
		new admin_setting_configselect(
			'local_buykart/payment_payumoney_currency',
			get_string(
				'currency',
				'local_buykart'
				),
...
//////////////////////////paytm setting Prashant//////////////////////////
	...
	$settings->add(
		new admin_setting_configselect(
			'local_buykart/payment_paytm_currency',
			get_string(
				'currency',
				'local_buykart'
				),
...
//instamojo payment setting page here 
	...
	//new instamojo currency code added by prasahant
	$paypalcurrencies = local_buykart_get_currencies();
	$settings->add(
		new admin_setting_configselect(
			'local_buykart/payment_instamojo_currency',
			get_string(
				'currency',
				'local_buykart'
				),
	...
	//new paytm currency code added by prasahant
