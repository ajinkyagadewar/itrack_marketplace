...
$plugin->version   = 2012012441;        // The current plugin version (Date: YYYYMMDDXX)

$plugin->requires  = 2012062500; // Requires this Moodle version 2.3
$plugin->component = 'local_course_extrasettings';       // Full name of the plugin (used for diagnostics)
