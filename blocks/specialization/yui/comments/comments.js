YUI.add('moodle-block_specialization-comments', function(Y) {

    var COMMENTSNAME = 'blocks_specialization_comments';
    ...
    M.blocks_specialization.init_comments = function(params) {
