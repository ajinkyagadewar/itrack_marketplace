YUI.add('moodle-block_institution-imagegallery', function(Y) {

    var IMAGEGALLERYNAME = 'blocks_institution_imagegallery';
    ...
    M.blocks_institution = M.blocks_institution || {};
    M.blocks_institution.init_imagegallery = function(params) {
