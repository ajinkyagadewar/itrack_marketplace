...
$PAGE->set_url($CFG->wwwroot . '/marketplace/product_details.php');
...
<head>
    ...
    <title>iTrack | Product Details</title>
...
<body>
    ...
    <section>
        <div class="container">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding bread_box">
                <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12 bread_left">
                    <div class="heading_bread">
                        <div class="title">
                            <span>Best Seller</span><h1>DevOps Certification Training</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container homecoursesmain">
            <div class="row">
                ...
                <div class="col-sm-12 padding-right">
                    ...
                    <h2 class="trending-crs">Product Details</h2>
