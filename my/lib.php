...
function student_courselist($userid,$creatorid,$roleid){
    ...
    $content = '';
    $msg = '';
    $content .= '<div class="col-lg-12 col-xlg-12 col-md-12">
    <div class="card">
        <!-- Nav tabs -->
        <ul class="nav nav-tabs profile-tab" role="tablist">
            <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#1" role="tab">ACADEMIC COURSES</a> </li>
            <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#2" role="tab">SUBSCRIBED INDUSTRY COURSES</a> </li>
            <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#3" role="tab">INDUSTRY PARTNER COURSES</a> </li>
        </ul>';
...
function usercourselist($role,array $courses, $coursetype){
    ...
    foreach ($courses as $course) {
        ...
        $viewcourse = html_writer::link(new moodle_url('/course/view.php',array('id' => $crs->id,'section'=>1)),'Start Learning',array('class'=>'courselistlink'));
        if($coursetype == 1){
            $crslist .= '<tr>
                            <td>'.$i.'</td>
                            <td>'.$crs->shortname.'</td>
