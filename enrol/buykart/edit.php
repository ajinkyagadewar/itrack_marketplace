...
/**
 * Adds new instance of enrol_buykart to specified course
...
require_capability('enrol/buykart:config', $context);

$PAGE->set_url('/enrol/buykart/edit.php', array('courseid' => $course->id));
...
$plugin = enrol_get_plugin('buykart');

if ($instances = $DB->get_records('enrol', array('courseid' => $course->id, 'enrol' => 'buykart'), 'id ASC')) {
...
$mform = new enrol_buykart_edit_form(null, array($instance, $plugin, $context));
...
$PAGE->set_title(get_string('pluginname', 'enrol_buykart'));
$PAGE->set_heading($course->fullname);

echo $OUTPUT->header();
echo $OUTPUT->heading(get_string('pluginname', 'enrol_buykart'));
$mform->display();
echo $OUTPUT->footer();
